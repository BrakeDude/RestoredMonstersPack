...
return function(mode)
    ...
    {Name="Sticky Long Legs",Anm2="sticky_long_legs.anm2",HP=20,StageHP=5,CollisionDamage=1,CollisionMass=20,CollisionRadius=20,ShadowSize=44,NumGridCollisionPoints=12,Type=200,Variant=2505,Tags="spider",Portrait=20,Reroll="true",},
