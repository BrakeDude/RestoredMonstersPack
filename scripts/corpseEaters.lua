...
function mod:CorpseEaterInit(entity)
	if iscorpseeater[entity.Variant] then    --entity.Variant == EntityVariant.VANILLA_CORPSE_EATER or entity.Variant == EntityVariant.VANILLA_CARRION_RIDER then
...
function mod:CorpseEaterUpdate(entity)
	if iscorpseeater[entity.Variant] then    --entity.Variant == EntityVariant.CORPSE_EATER or entity.Variant == EntityVariant.CARRION_RIDER then
		local data = entity:GetData()
